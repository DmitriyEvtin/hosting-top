...
export const emailTemplates: Record<string, EmailTemplate> = {
  welcome: {
    subject: "Добро пожаловать в Каталог металлопроката",
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        <div style="background-color: #f8f9fa; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
          ...
          <p style="color: #666; margin: 0 0 15px 0;">Ваш аккаунт был успешно создан в системе Каталог металлопроката.</p>
  ...
  passwordReset: {
    subject: "Сброс пароля - Каталог металлопроката",
  ...
  userCreated: {
    subject: "Новый пользователь создан - Каталог металлопроката",
  ...
  userUpdated: {
    subject: "Профиль обновлен - Каталог металлопроката",
