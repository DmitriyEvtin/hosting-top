    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>Проверка конфигурации Sentry...</CardDescription>
        </CardHeader>
        <CardContent>
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>Ошибка диагностики Sentry</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="text-red-600 mb-4">{error}</div>
          <Button onClick={fetchDiagnosis} variant="outline" size="sm">
