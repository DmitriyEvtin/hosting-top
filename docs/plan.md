...
- **Мониторинг:** Sentry, CloudWatch, LogRocket
...
- [ ] Настройка ESLint с FSD правилами
- [ ] Настройка Prettier
- [ ] Настройка Husky и lint-staged
- [ ] Настройка Steiger для проверки FSD архитектуры
- [ ] Настройка VS Code расширений и настроек
...
- [ ] Создание .env файлов для разных окружений
- [ ] Настройка DATABASE_URL
- [ ] Настройка NEXTAUTH конфигурации
- [ ] Подготовка AWS S3 настроек
...
- [ ] Workflow для проверки кода (lint, type-check, tests)
...
*План будет обновляться по мере прогресса разработки и получения фидбека.*
