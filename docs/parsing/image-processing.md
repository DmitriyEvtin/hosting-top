...
class CaravaggioService {
  ...
  async processImage(imageUrl: string, options: CaravaggioOptions): Promise<Buffer>
  async resizeImage(imageUrl: string, width: number, height: number): Promise<Buffer>
  ...
  private buildCaravaggioUrl(imageUrl: string, options: CaravaggioOptions): string
